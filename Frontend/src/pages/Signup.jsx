...
const Signup = () => {
  ...
  const handleChange = (e) => setForm({ ...form, [e.target.name]: e.target.value }); // ...form because without this you would potentially replace the entire object with only any of the fields
  // like
  // {
  //   email: "dwipraj@gmail.com"
  // }
  // Then name and password would disappear.
        ...
        <div className="flex items-center justify-center px-4 py-20">
          <div className="w-full max-w-md bg-[#111118] border border-white/10 rounded-2xl p-8 shadow-2xl">
            ...
            <p className="text-gray-400 text-sm mt-1">
              Start tracking expenses with your AI-powered assistant.
            </p>
